...
<div className="flex flex-col mb-4">
  ...
  <div className="flex flex-col mb-4">
    <label htmlFor="email" className="mb-2 uppercase text-sm text-grey-darkest" > 电 邮</label>
      <input className="border focus:border-red-500 py-2 px-3 text-grey-darkest" type="email" name="email" id="email" />

    </div>

    <div className="flex flex-col mb-4">
    <label htmlFor="message" className="mb-2 uppercase text-sm text-grey-darkest" > 短 信 </label>
